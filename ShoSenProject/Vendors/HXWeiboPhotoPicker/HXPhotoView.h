...
#import "SSCirclePublishFooter.h"


typedef void(^HXPhotoViewLocationBlock)(NSString *location);
typedef void(^HXPhotoViewContentBlock)(NSString *content);
...
@property (nonatomic, copy)   HXPhotoViewLocationBlock  block;
@property (nonatomic, copy)   HXPhotoViewContentBlock  contentBlock;
@property (nonatomic, strong) SSCirclePublishHeader *headerview;
@property (nonatomic, strong) SSCirclePublishFooter *footerview;
