//
//  SSSearchShopOrderListVC.m
//  ShoSenProject
//
//  Created by lifuzhou on 2019/1/8.
...
@interface SSSearchShopOrderListVC ()<UITableViewDataSource, UITableViewDelegate,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@implementation SSSearchShopOrderListVC

- (void)viewDidLoad {
    [super viewDidLoad];

    self.title = @"搜索结果";
    self.searchView.frame = CGRectMake(5, 15, kwidth - 30, 34);
    self.navigationController.navigationItem.titleView = self.searchView;
...
- (UIImage *)imageForEmptyDataSet:(UIScrollView *)scrollView {
    return [UIImage imageNamed:@"shopOrder_null"];
}
...
{
    [self.viewModel searchShopOrderListWithType:type goodsName:self.search_string callback:^(id  _Nonnull object) {
