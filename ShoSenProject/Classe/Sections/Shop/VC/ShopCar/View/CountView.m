...
//        [_leftBtn setImage:[UIImage imageNamed:@"shopCar_cut"] forState:UIControlStateNormal];
        ...
        [_leftBtn setTitleColor:kColor(@"d2d2d2") forState:UIControlStateNormal];
    }
    return _leftBtn;
}
...
- (UITextField *)countTF{
    if (_countTF == nil) {
        ...
        _countTF.textColor = kColor(@"d2d2d2");
...
-(UIButton *)rightBtn{
    if (_rightBtn == nil) {
        ...
        [_rightBtn setTitleColor:kColor(@"d2d2d2") forState:UIControlStateNormal];
